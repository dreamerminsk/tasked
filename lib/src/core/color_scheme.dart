...
ColorProperty get onSurface => ColorProperty('onSurface', colorScheme.onSurface);
ColorProperty get onSurfaceVariant => ColorProperty('onSurfaceVariant', colorScheme.onSurfaceVariant);
...
List<(ColorProperty,ColorProperty)> get  pairs => <(ColorProperty,ColorProperty)>[
(primary,
onPrimary),
(primaryContainer,
onPrimaryContainer),
...
(errorContainer,
onErrorContainer),
(outline, ColorProperty('~onOutline~',ColorUtils.contrastThemeColor(outline))),
(outlineVariant, ColorProperty('~onOutlineVariant~',ColorUtils.contrastThemeColor(outlineVariant))),
(surface,onSurface),
...
(shadow, ColorProperty('~onShadow~',ColorUtils.contrastThemeColor(shadow))),
(scrim, ColorProperty('~onScrim~',ColorUtils.contrastThemeColor(scrim))),
(surfaceTint, ColorProperty('~onSurfaceTint~',ColorUtils.contrastThemeColor(surfaceTint))),
];
